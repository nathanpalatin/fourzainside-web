  ...
  return (
    <div className="h-screen mt-2 ml-4 w-[240px] overflow-y-hidden ">
      <div className="flex flex-col items-center space-y-3 p-2">
        <a href="/dashboard" className="bg-zinc-900 hover:border-indigo-700  transition-all flex justify-start items-center rounded border border-zinc-700 w-full h-16">
        ...
        <a href='/dashboard/sales' className="bg-zinc-900 hover:border-indigo-700  transition-all hover:bg-zinc-900/90 flex justify-start items-center rounded border border-zinc-700 w-full h-16">
          <div className="flex gap-2 m-2 ">
        ...
        <a href='/dashboard/projects' className="bg-zinc-900 hover:border-indigo-700  transition-all hover:bg-zinc-900/90 flex justify-start items-center rounded border border-zinc-700 w-full h-16">
          <div className="flex gap-2 m-2 ">
